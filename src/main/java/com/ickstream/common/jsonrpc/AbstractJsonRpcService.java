...
public class AbstractJsonRpcService {
    ...
    public <T> AbstractJsonRpcService(T serviceImplementation, Class<T> serviceInterface) {
        this(serviceImplementation, serviceInterface, false);
    }

    public <I, T extends I> AbstractJsonRpcService(T serviceImplementation, Class<I> serviceInterface, Boolean returnOnVoid) {
